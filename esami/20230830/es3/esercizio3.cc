...
int trovaIlPianetaDiPartenza(int numeroDiPianeti) {
    ...
    // Per esempio:
    int identificativoPianetaDiPartenza = 0;   // E' possibile inizializzare con un valore apposito
    int carburanteIniziale = 1;                // Inizializzare con il carburante presente all'inizio del viaggio
...
bool trovaIlPianetaDiPartenza_rec(int& identificativoPianetaDiPartenza, int carburanteCorrente, int numeroDiPianeti, int tentativi) {
    ...
    else if (/* identificativoPianetaDiPartenza == 0 && */ tentativi == numeroDiPianeti ) {
    ...
    //              (per esempio, la variabile "identificativoPianetaDiPartenza" ha un valore apposito)
        ...
        carburanteCorrente = carburanteCorrente+(carburantePianetaCorrente-distanzaPianetaCorrente);
        ...
        bool t = trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi);
        ...
        //    5.5 invocare ricorsivamente "trovaIlPianetaDiPartenza_rec"
            ...
            trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi);
        }
